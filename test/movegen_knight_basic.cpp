...
TEST(movegen_knight_basic, white_knight_center) {
  ...
  EXPECT_BITBOARD(receiver.knightOrigins(), 34359738368);
  EXPECT_BITBOARD(receiver.knightTargets(), 5666883501293568);
}
...
TEST(movegen_knight_basic, white_knight_bottom_right) {
  ...
  EXPECT_BITBOARD(receiver.knightOrigins(), 128);
  EXPECT_BITBOARD(receiver.knightTargets(), 4202496);
}
...
TEST(movegen_knight_basic, white_knight_top_right) {
  ...
  EXPECT_EQ(receiver.knightMoveCount(), 2);
  EXPECT_BITBOARD(receiver.knightOrigins(), 9223372036854775808ull);
  EXPECT_BITBOARD(receiver.knightTargets(), 9077567998918656);
}
...
TEST(movegen_knight_basic, white_knight_top_left) {
  ...
  EXPECT_EQ(receiver.knightMoveCount(), 2);
  EXPECT_BITBOARD(receiver.knightOrigins(), 72057594037927936);
  EXPECT_BITBOARD(receiver.knightTargets(), 1128098930098176);
}
...
TEST(movegen_knight_basic, white_knight_bottom_left) {
  ...
  EXPECT_EQ(receiver.knightMoveCount(), 2);
  EXPECT_BITBOARD(receiver.knightOrigins(), 1);
  EXPECT_BITBOARD(receiver.knightTargets(), 132096);
}
