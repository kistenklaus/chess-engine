...
TEST(movegen_rook_basic, white_rook_no_blocker_center) {
  ...
  EXPECT_EQ(receiver.rookOrigins(), 34359738368);
  EXPECT_EQ(receiver.rookTargets(), 578722409201797128);
}
...
TEST(movegen_rook_basic, white_rook_no_blocker_left_border) {
  ...
  EXPECT_EQ(receiver.rookMoveCount(), 14);
  EXPECT_EQ(receiver.rookOrigins(), 4294967296);
  EXPECT_EQ(receiver.rookTargets(), 72341259464802561);
}
...
TEST(movegen_rook_basic, white_rook_no_blocker_top_border) {
  ...
  generate_moves<state>(board, receiver);
  EXPECT_EQ(receiver.rookMoveCount(), 14);
  EXPECT_EQ(receiver.rookOrigins(), 576460752303423488ull);
  EXPECT_EQ(receiver.rookTargets(), 17800486357769390088ull);
}
...
TEST(movegen_rook_basic, white_rook_no_blocker_right_border) {
  ...
  generate_moves<state>(board, receiver);
  EXPECT_EQ(receiver.rookMoveCount(), 14);
  EXPECT_EQ(receiver.rookOrigins(), 549755813888);
  EXPECT_EQ(receiver.rookTargets(), 9259542118978846848ull);
}
...
TEST(movegen_rook_basic, white_rook_no_blocker_bottom_border) {
  ...
  generate_moves<state>(board, receiver);
  EXPECT_EQ(receiver.rookMoveCount(), 14);
  EXPECT_EQ(receiver.rookOrigins(), 8);
  EXPECT_EQ(receiver.rookTargets(), 578721382704613623ull);
}
...
TEST(movegen_rook_basic, white_rook_friendly_blocker_right) {
  ...
  EXPECT_EQ(receiver.rookOrigins(), 67108864);
  EXPECT_EQ(receiver.rookTargets(), 289360691738182660);
}
...
TEST(movegen_rook_basic, white_rook_friendly_blocker_top) {
  ...
  EXPECT_EQ(receiver.rookOrigins(), 67108864);
  EXPECT_EQ(receiver.rookTargets(), 4419437724676);
}
...
TEST(movegen_rook_basic, white_rook_friendly_blocker_left) {
  ...
  generate_moves<state>(board, receiver);
  EXPECT_EQ(receiver.rookMoveCount(), 11);
  EXPECT_EQ(receiver.rookOrigins(), 137438953472);
  EXPECT_EQ(receiver.rookTargets(), 2314886321092436000ull);
}
...
TEST(movegen_rook_basic, white_rook_friendly_blocker_bottom) {
  ...
  EXPECT_EQ(receiver.rookMoveCount(), 12);
  EXPECT_EQ(receiver.rookOrigins(), 137438953472);
  EXPECT_EQ(receiver.rookTargets(), 2314886351157198848ull);
}
