...
inline checkmask_t generate_checkmask(const Board
                                                                 &board) {
  ...
  iterate_bits(hvSliding, enemyRooksAndQueens) {
    ...
    checkmask |= (southLookup & board.King<state.turn()>() &&
    ...
    checkmask |= (westLookup & board.King<state.turn()>() &&
    ...
    checkmask |= (northLookup & board.King<state.turn()>() &&
    ...
    checkmask |= (eastLookup & board.King<state.turn()>() &&
  ...
  iterate_bits(dSliding, enemyBishopsAndQueens) {
    ...
    checkmask |= (southEastLookup & board.King<state.turn()>() &&
    ...
    checkmask |= (southWestLookup & board.King<state.turn()>() &&
    ...
    checkmask |= (northWestLookup & board.King<state.turn()>() &&
    ...
    checkmask |= (northEastLookup & board.King<state.turn()>() &&
